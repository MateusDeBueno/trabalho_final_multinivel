...
% hold on
% % for k=0:30:360
% %     plot(reta_angulo(0,0,3,k))
% % end
% plot(reta_angulo(0,0,3,0))
% plot(reta_angulo(0,0,3,90))
% plot(reta_angulo(0,0,3,-145))
% hold off
...
xlabel('Alpha')
ylabel('Beta')
save_figure('capacidade_pwm.pdf')
...
fs = 1440; %frequencia de amostragem (7 segmentos)
